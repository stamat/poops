...
describe('the published schema', () => {
  ...
  it('lists every exec key that actually fires, in all three spellings, and none that never would', () => {
    expect(Object.keys(schema.definitions.exec.properties).sort()).toEqual([...EXEC_KEYS].sort())
