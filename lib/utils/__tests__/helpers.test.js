...
describe('discoverImageVariants', () => {
  it('discovers variants and prefers webp for srcset', () => {
    const result = discoverImageVariants('images/photo.jpg', FIXTURES)
