...
export default class Markups {
  ...
  async compile() {
    ...
    const collectionPromises = [
      ...generateCollectionPaginationPages(collectionData, this.markupIn, this.markupOut, this.compileEntry.bind(this), this.baseURL),
      ...generateTaxonomyPages(collectionData, this.markupIn, this.markupOut, this.compileEntry.bind(this), this.baseURL)
    ]
