...
module.exports = class Markups {
  ...
  compile() {
    ...
    if (pathIsDirectory(markupIn)) {
        ...
        if (relativePathParts.length > 1 &&
          ...
          if (frontMatter.paginate) {
            ...
            for (let i = 0; i < collection.totalPages; i++) {
              ...
              collectionData.rootPathPrefix = this.getRootPathPrefix(markupOutDir)
      ...
      additionalContext.rootPathPrefix = this.getRootPathPrefix(markupOutDir)
