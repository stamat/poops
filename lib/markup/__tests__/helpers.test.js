...
describe('breadcrumbCrumbs', () => {
  ...
  it('builds a Home > collection > term trail for a taxonomy page, ignoring URL depth', () => {
    ...
    expect(breadcrumbCrumbs(
      { title: 'Changelog', url: 'changelog/tag/feature/2', _taxonomy: { collection: 'changelog', term: 'feature', termUrl: 'changelog/tag/feature' } },
      { url: 'https://ex.com' }
    )).toEqual([
      { name: 'Home', path: '' },
      { name: 'Changelog', path: 'changelog' },
      { name: 'Feature', path: 'changelog/tag/feature' }
    ])
  })
})
