...
describe('heading renderer', () => {
  ...
  // they used to end up glued into the class (`language-htmlpreview`).
  it('takes the language class from the first word of the info string', () => {
    const result = parseMarkdown('```html preview\n<b>x</b>\n```')
    expect(result).toContain('class="hljs language-html"')
  })
