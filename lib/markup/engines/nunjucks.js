...
import { discoverImageVariants, parseFrontMatter, groupby, buildImageTag, buildPaginationTag, renderToc, buildJsonLd, buildOpenGraph, buildCanonical, buildBreadcrumb, buildMetaDescription } from '../helpers.js'
...
export default class NunjucksEngine {
  ...
  registerFilters({ dateFormat, markupOut }) {
    ...
    env.addFilter('description', (page, site) => new nunjucks.runtime.SafeString(buildMetaDescription(page, site)))
